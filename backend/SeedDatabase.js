...
// // Subjects
// const subjects = [
//     { subjectId: "SUB001", name: "Mathematics", department: "CSE" },
//     { subjectId: "SUB002", name: "Mathematics Lab", department: "CSE" },
//     { subjectId: "SUB003", name: "Physics", department: "CSE" },
//     { subjectId: "SUB004", name: "Physics Lab", department: "CSE" },
//     { subjectId: "SUB005", name: "Electronics", department: "CSE" },
//     { subjectId: "SUB006", name: "Electronics Lab", department: "CSE" },
//     { subjectId: "SUB007", name: "Chemistry", department: "CSE" },
//     { subjectId: "SUB008", name: "Chemistry Lab", department: "CSE" },
//     { subjectId: "SUB009", name: "Computer Science", department: "CSE" },
//     { subjectId: "SUB010", name: "Computer Science Lab", department: "CSE" }


// ]
// // Teachers Data
// const teachers = [
//     { teacherId: "T001", name: "Rajesh Kumar", dob: "1985-05-05", password: "1985-05-05", sections: ["CSE-A", "CSE-B", "ECE"], subjects: ["SUB001", "SUB002"] },
//     { teacherId: "T002", name: "Anjali Sharma", dob: "1986-06-06", password: "1986-06-06", sections: ["EEE", "Civil", "Mech"], subjects: ["SUB001", "SUB002"] },
//     { teacherId: "T003", name: "Suresh Iyer", dob: "1987-07-07", password: "1987-07-07", sections: ["CSE-A", "CSE-B", "ECE"], subjects: ["SUB003", "SUB004"] },
//     { teacherId: "T004", name: "Pooja Reddy", dob: "1984-03-15", password: "1984-03-15", sections: ["EEE", "Civil", "Mech"], subjects: ["SUB003", "SUB004"] },
//     { teacherId: "T005", name: "Arun Prasad", dob: "1988-08-20", password: "1988-08-20", sections: ["CSE-A", "CSE-B", "ECE"], subjects: ["SUB005", "SUB006"] },
//     { teacherId: "T006", name: "Vivek Patel", dob: "1983-12-10", password: "1983-12-10", sections: ["EEE", "Civil", "Mech"], subjects: ["SUB005", "SUB006"] },
//     { teacherId: "T007", name: "Meena Chawla", dob: "1982-11-25", password: "1982-11-25", sections: ["CSE-A", "CSE-B", "ECE"], subjects: ["SUB007", "SUB008"] },
//     { teacherId: "T008", name: "Amit Verma", dob: "1981-09-30", password: "1981-09-30", sections: ["EEE", "Civil", "Mech"], subjects: ["SUB007", "SUB008"] },
//     { teacherId: "T009", name: "Neha Agarwal", dob: "1989-04-18", password: "1989-04-18", sections: ["CSE-A", "CSE-B", "ECE"], subjects: ["SUB009", "SUB010"] },
//     { teacherId: "T010", name: "Rahul Desai", dob: "1980-02-17", password: "1980-02-17", sections: ["EEE", "Civil", "Mech"], subjects: ["SUB009", "SUB010"] }
// ];
...
//         // Fetch subject ObjectIds
//         const subjectsMap = {};
//         (await Subject.find()).forEach(sub => subjectsMap[sub.subjectId] = sub._id);

//         // Convert teacher subject IDs to ObjectIds
//         teachers.forEach(teacher => {
//             teacher.subjects = teacher.subjects.map(subId => subjectsMap[subId]);
//         });

//         const insertedTeachers = await Teacher.insertMany(teachers);
//         console.log("Inserted Teachers: ", insertedTeachers);
