...
// // // import "bootstrap/dist/css/bootstrap.min.css"; // Bootstrap for icons
...
// // //       if (credentials.id.startsWith("A")) navigate("/admin/dashboard");
// // //       else if (credentials.id.startsWith("T")) navigate("/teacher/dashboard");
// // //       else if (credentials.id.startsWith("S")) navigate("/student/dashboard");
// // //     } catch (err) {
...
// // //           {/* LOGIN BUTTON & FORGOT PASSWORD (SIDE-BY-SIDE) */}
