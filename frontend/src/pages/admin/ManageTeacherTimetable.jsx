...
// // //     timetable.teacherId.toLowerCase().includes(searchQuery.toLowerCase())
// // //   );
...
// // //               <td>{timetable.subjectId?.name || "Unknown"}</td>
// // //               <td>{timetable.day}</td>
...
// // //               <Form.Control type="text" name="day" value={timetableData.day} onChange={handleChange} />
// // //             </Form.Group>
// // //             <Form.Group className="mb-2">
// // //               <Form.Label>Time Slot</Form.Label>
// // //               <Form.Control type="text" name="timeSlot" value={timetableData.timeSlot} onChange={handleChange} />
// // //             </Form.Group>
// // //           </Form>
// // //         </Modal.Body>
// // //         <Modal.Footer>
// // //           <Button variant="secondary" onClick={resetForm}>Close</Button>
// // //           <Button variant="primary" onClick={isEditing ? updateTimetable : addTimetable}>{isEditing ? "Update" : "Save"}</Button>
// // //         </Modal.Footer>
// // //       </Modal>
// // //     </div>
// // //   );
...
// // //     const classSession = filteredTimetables.find(
// // //       (timetable) => timetable.day === day && timetable.timeSlot === timeSlot
// // //     );

// // //     if (!classSession) return null;

// // //     return {
// // //       subject: classSession.subjectId?.name || "Unknown",
...
// // //                     return (
// // //                       <td key={`${day}-${timeSlot}`} className={classDetails ? "has-class" : ""}>
// // //                         {classDetails ? (
...
// //   // Parse time string to get hour as a number (for comparison)
...
// //     return hour + parseInt(minuteStr || 0, 10) / 60;
// //   };

// //   // Parse a time slot to get start and end times in hours
// //   const parseTimeSlot = (timeSlot) => {
// //     const parts = timeSlot.split(' - ');
// //     if (parts.length !== 2) return null;
    
// //     let startTimeStr = parts[0].trim();
// //     let endTimePart = parts[1].trim();
    
// //     // Handle case where AM/PM is only in the end part
// //     if (!startTimeStr.includes('AM') && !startTimeStr.includes('PM')) {
// //       if (endTimePart.includes('AM')) {
// //         startTimeStr += ' AM';
// //       } else if (endTimePart.includes('PM')) {
// //         startTimeStr += ' PM';
// //       }
// //     }
    
// //     // Extract end time without the "(2 hours)" if present
// //     const endTimeStr = endTimePart.split(' (')[0].trim();
    
// //     return {
// //       start: parseTimeToHours(startTimeStr),
// //       end: parseTimeToHours(endTimeStr)
// //     };
// //   };
...
// //     // Overlap occurs if one slot starts before the other ends
...
// //     if (matchingClass) {
// //       const matchingTime = parseTimeSlot(matchingClass.timeSlot);
// //       const currentTime = parseTimeSlot(timeSlot);
      
// //       // Check if this is the starting time slot of the class
// //       const isStartingSlot = Math.abs(matchingTime.start - currentTime.start) < 0.1;
...
// //         duration: getSlotDuration(matchingClass.timeSlot)
// //       };
// //     }
