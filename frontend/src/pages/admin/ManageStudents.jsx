...
// //       <Table className="students-table" striped bordered hover>
// //         <thead>
// //           <tr>
// //             <th>ID</th>
// //             <th>Name</th>
...
// //                 <Button variant="warning" className="action-btn edit-btn" onClick={() => handleEdit(student)}>
// //                   Edit
// //                 </Button>
// //                 <Button variant="danger" className="action-btn delete-btn" onClick={() => handleDelete(student._id)}>
// //                   Delete
// //                 </Button>
// //               </td>
// //             </tr>
...
//     try {
//       const response = await axiosInstance.post("/students", newStudentData);
//       setStudents([...students, response.data.student]); // Use .student as per backend
